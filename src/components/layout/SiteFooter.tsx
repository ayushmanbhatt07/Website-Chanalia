          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-9 h-9 rounded-lg bg-[#131b2e] border border-[#1F2937] flex items-center justify-center text-slate-400 hover:text-white hover:border-slate-500 transition-colors"
                aria-label="Facebook"
              >
