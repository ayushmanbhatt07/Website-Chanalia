...
export function SiteFooter() {
  return (
    <footer className="bg-[#050811] text-white border-t border-white/[0.08] relative overflow-hidden">
      {/* Top Status Bar */}
      <div className="border-b border-white/[0.06] bg-slate-950/60 py-3.5">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-9 h-9 rounded-lg bg-slate-900 border border-white/[0.08] flex items-center justify-center text-slate-400 hover:text-white hover:border-white/[0.2] transition-colors"
                aria-label="Facebook"
              >
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li className="pt-2">
                <Link
                  href="/products"
                  className="text-xs font-mono font-semibold text-sky-400 hover:underline inline-flex items-center gap-1"
                >
                  Full 68-SKU Catalog →
                </Link>
              </li>
      ...
      {/* Bottom Bar */}
      <div className="border-t border-white/[0.06] bg-[#03050B]">
        <Container className="py-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-500 font-mono">
          <p>{site.copyright}</p>
